<template>
  <nav class="sticky top-0 z-10 bg-white border-b border-gray-100 shadow-sm">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          ...
          <button
            @click="toggleSidebar"
            class="inline-flex items-center justify-center p-2 text-gray-500 rounded-md md:hidden hover:text-gray-900 hover:bg-gray-100"
          >
            <svg 
        ...
        <div class="flex items-center">
          ...
          <div class="relative ml-3">
            <button
              class="flex text-sm bg-gray-200 rounded-full focus:outline-none"
            >
  ...
  <div v-if="showMobileSidebar" class="fixed inset-0 z-50 bg-black bg-opacity-50 md:hidden" @click="closeSidebar">
    <div class="w-64 h-full bg-white shadow-lg" @click.stop>
      ...
      <div class="p-4">
        <ul class="space-y-2">
          <li>
            <NuxtLink to="/" class="flex items-center p-2 rounded-md hover:bg-gray-100">
          ...
          <li>
            <NuxtLink to="/ContainerTracking" class="flex items-center p-2 rounded-md hover:bg-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-3">
          ...
          <li>
            <NuxtLink to="/CusDecTracking" class="flex items-center p-2 rounded-md hover:bg-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-3">
          ...
          <li>
            <NuxtLink to="/CusDecOwnership" class="flex items-center p-2 rounded-md hover:bg-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-3">
