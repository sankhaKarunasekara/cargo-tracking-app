...
<template>
  <Card :class="cardClass">
    ...
    <div class="hidden lg:flex">
      <div class="flex-grow min-w-0 p-4">
          ...
          <div class="flex items-start">
            ...
            <div class="min-w-0">
              ...
              <div class="flex items-center mt-1 text-xs text-gray-500">
                <span class="flex items-center px-1.5 py-0.5 bg-blue-50 text-blue-600 rounded font-medium">
        ...
        <div class="grid grid-cols-2 gap-4 mt-4">
          ...
          <div>
            ...
            <div class="flex space-x-4 mb-3">
              <div>
                <p class="flex items-center text-sm font-medium text-gray-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" class="mr-1 text-blue-600">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <path d="M13 4a1 1 0 0 1 1 1h4a1 1 0 0 1 .783 .378l.074 .108l3 5l.055 .103l.04 .107l.029 .109l.016 .11l.003 .085v6a1 1 0 0 1 -1 1h-1.171a3.001 3.001 0 0 1 -5.658 0h-4.342a3.001 3.001 0 0 1 -5.658 0h-1.171a1 1 0 0 1 -1 -1v-11a2 2 0 0 1 2 -2zm-6 12a1 1 0 1 0 0 2a1 1 0 0 0 0 -2m10 0a1 1 0 1 0 0 2a1 1 0 0 0 0 -2m.434 -9h-3.434v3h5.234z" />
                  </svg>
                  Containers
            ...
            <div v-if="cusdec.status.toLowerCase() !== 'waiting confirmation'" class="flex flex-wrap gap-2 mt-2 pt-2 border-t border-gray-100">
              <!-- Yard Location -->
              <div 
                :class="[
      ...
      <div 
        class="flex flex-col justify-center flex-shrink-0 w-56 p-4 border-l" 
        :class="cusdec.status.toLowerCase() === 'waiting confirmation' ? 'bg-yellow-50 border-yellow-300' : 'bg-gray-50 border-gray-100'"
      >
