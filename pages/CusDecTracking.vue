        ...
        <div class="space-y-4">
          ...
          <div class="mb-4">
            ...
            <div class="space-y-3">
              <div>
                ...
                <input id="startDateMobile" type="date" v-model="dateRange.startDate"
              ...
              <div>
                ...
                <input id="endDateMobile" type="date" v-model="dateRange.endDate"
                  class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  @change="updateDateRange(dateRange.startDate, dateRange.endDate)" />
              </div>
            </div>
          ...
          <div class="space-y-4">
            <div v-for="filter in filters" :key="filter.id" class="space-y-1">
              <label :for="filter.id + 'Mobile'" class="block text-sm font-medium text-gray-700">{{ filter.label
              }}</label>
              <select v-if="filter.type === 'select'" :id="filter.id + 'Mobile'"
                class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                :value="filter.value"
              ...
              <input v-else :id="filter.id + 'Mobile'" type="text"
      ...
      <div class="flex flex-col md:flex-row md:space-x-6">
        ...
        <div class="flex-1">
          ...
          <div class="mt-0">
            ...
            <div v-if="filteredCusDecs.length === 0"
            ...
            <div v-else>
              ...
              <div class="w-full space-y-4">
                <CusDecCard v-for="cusdec in paginatedCusDecs" :key="cusdec.id" :cusdec="cusdec"
                  @view-timeline="handleViewTimeline" @view-details="handleViewDetails" class="mb-4" />
                ...
                <div v-if="!isMobile" class="flex items-center justify-center mt-2">
                  <p class="text-xs text-gray-500"> Showing <span class="font-medium">{{ ((currentPage - 1) *
                    itemsPerPage) + 1 }}</span> to <span class="font-medium">{{ Math.min(currentPage * itemsPerPage,
                        filteredCusDecs.length) }}</span> of <span class="font-medium">{{ filteredCusDecs.length }}</span>
                    results </p>
                </div>
              </div>
            </div>
